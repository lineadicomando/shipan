...
| 33 | [A school can be followed](33-a-school-can-be-followed.md) | done — narrows «every divergence is a parameter»; the audit behind it finds three faults, claims two candidates as one, and catches the register overstating a comparison |
